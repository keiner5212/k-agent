...
export const SETTINGS_REGISTRY: readonly SettingsSectionDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        type: "imagePicker",
        titleKey: "settings.chatBackgroundImage.label",
        descriptionKey: "settings.chatBackgroundImage.description",
        keywords: [
          "background",
          "wallpaper",
          "image",
      ...
      {
        id: "chatBackgroundOpacity",
        type: "slider",
        titleKey: "settings.chatBackgroundOpacity.label",
        descriptionKey: "settings.chatBackgroundOpacity.description",
        keywords: [
          "opacity",
          "transparency",
          "alpha",
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "buildAgentEnabled",
        type: "toggle",
        titleKey: "settings.buildAgentEnabled.label",
        descriptionKey: "settings.buildAgentEnabled.description",
        keywords: ["agent", "build", "builtin", "agente", "construir"],
      },
      {
        id: "planAgentEnabled",
        type: "toggle",
        titleKey: "settings.planAgentEnabled.label",
        descriptionKey: "settings.planAgentEnabled.description",
  ...
  },
  {
    ...
    descriptionKey: "lsps.description",
    keywords: [
      "lsp",
      "language",
      "server",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "editor.undo",
        type: "keybinding",
        titleKey: "settings.keybindings.actions.editor.undo",
        descriptionKey: "settings.keybindings.description",
        keywords: ["shortcut", "hotkey", "undo", "deshacer", "ctrl"],
      },
      {
        id: "editor.redo",
        type: "keybinding",
        titleKey: "settings.keybindings.actions.editor.redo",
        descriptionKey: "settings.keybindings.description",
        keywords: ["shortcut", "hotkey", "redo", "rehacer", "ctrl"],
      },
    ],
  },
  {
